# =============================================================================
# dag_serie_c.py - Pipeline de dados do Brasileirão Série C
# =============================================================================
# Liga: Brasileirão Série C (ID 75)
# Execução: toda sexta-feira às 6h
# Estimativa: ~51 páginas = ~51 requisições
#
...
with DAG(
    ...
    description="Coleta jogadores da Série C via API-Football e salva no PostgreSQL",
    schedule_interval="0 6 * * 5",  # toda sexta-feira às 6h
    start_date=datetime(2025, 1, 1),
    catchup=False,
    tags=["selecao", "serie_c", "pipeline"],
) as dag:
